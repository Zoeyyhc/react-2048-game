...
describe("gameReducer", () => {
  describe("clean_up", () => {
    it("shoudld remove all tiles that are not referenced on the board", () => {
      const tile1: Tile = {
        position: [0, 1],
        value: 2,
      };
  ...
  describe("move_up", () => {
    it("should move files to the top of the board", () => {
      const tile1: Tile = {
        position: [0, 1],
        value: 2,
      };
    ...
    it("should stack files with the same value on the top of each other", () => {
      const tile1: Tile = {
        position: [0, 1],
        value: 2,
      };
    ...
    it("should merge files with the same values", () => {
      const tile1: Tile = {
        position: [0, 1],
        value: 2,
      };
  ...
  describe("move_down", () => {
    ...
    it("should keep the orginal order of tiles (regression test)", () => {
      const tile1: Tile = {
        position: [0, 1],
        value: 4,
      };
